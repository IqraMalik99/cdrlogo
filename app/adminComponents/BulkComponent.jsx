    ...
    <div style={{ background: bg, minHeight: "100vh", padding: "28px 24px", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ margin: 0, fontSize: 13, color: muted }}>
          Upload a single wrapper ZIP containing multiple logo ZIPs. Each inner ZIP becomes one logo — name and SEO are auto-generated by AI.
        </p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div style={{
          ...
          {[
            ...
            { step: "2", label: "Inner ZIPs",  desc: "Each ZIP = one logo (name from filename)" },
